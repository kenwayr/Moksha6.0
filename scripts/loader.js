$(document).ready(function () {
	$("#logo-fade").removeClass("inactive");
	/*replaceWithPaths("#LandingLogo > svg");
	startSVGAnimation('#LandingLogo > svg');*/
	setTimeout(function (){
		$(".tiny").removeClass("tiny");
		$("#loader-overlay").fadeOut(2000, function(){
			$(".fade-in").removeClass("inactive");
			$(".sit-in").removeClass("sit-in");
			$(this).removeClass("active");

			$("html").off("DOMMouseScroll mousewheel mousemove keydown", false); //reactivate all 
		});
	}, 4000);
});
/*
