...
$(function () {
    ...
    canvas = $("#floaterCanvas").get(0); //this "get(0) will pull the underlying non-jquery wrapped dom element from our selection
    canvas.width = W;
    canvas.height = H;
    ...
    function Particle() {
        ...
        this.x = Math.random() * K;
        this.y = Math.random() * K;
        this.direction = {
            "x": -1 + Math.random() * 2,
            "y": -1 + Math.random() * 2
        };
